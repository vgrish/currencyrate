 ...
 * Update an Item
 */
class currencyrateItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('currencyrate_item_err_ns');
		}
...
return 'currencyrateItemUpdateProcessor';
